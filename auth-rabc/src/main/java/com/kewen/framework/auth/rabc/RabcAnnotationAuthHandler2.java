 ...
 *     使用JDBC来处理，可以实现表名、字段的自定义了
 * @author kewen
 * @since 2023-12-28
 */
@Deprecated
public class RabcAnnotationAuthHandler2 implements AnnotationAuthHandler<Long> {
    ...
    @Override
    public boolean hasDataOperateAuths(Collection<BaseAuth> auths, String businessFunction, Long dataId, String operate) {
