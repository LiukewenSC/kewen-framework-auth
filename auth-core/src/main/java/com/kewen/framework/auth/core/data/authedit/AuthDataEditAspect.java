package com.kewen.framework.auth.core.data.authedit;


import com.kewen.framework.auth.core.data.AuthDataHandler;
import com.kewen.framework.auth.core.AuthDataAuthEdit;
...
public class AuthDataEditAspect {
    ...
    private AuthDataHandler annotationAuthAdaptor;



    @Pointcut("@annotation(com.kewen.framework.auth.core.AuthDataAuthEdit)")
    ...
    public void setAnnotationAuthAdaptor(AuthDataHandler annotationAuthAdaptor) {
