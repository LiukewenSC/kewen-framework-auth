...
public class SimpleAuthObject extends AbstractAuthObject {
    ...
    @Override
    protected void setBaseAuth(List<IAuthEntityProvider> abstractAuthEntities) {
        for (IAuthEntityProvider abstractAuthEntity : abstractAuthEntities) {
     ...
     */
    protected void setAnotherBaseAuth(IAuthEntityProvider abstractAuthEntity){
