...
public class MybatisPlusCodeGenerator {
    ...
    public static class Config {
         ...
         * 为空则表示用代码生成器在的路径
         */
        public static final String ABSOLUTE_PATH = "D:\\Projects\\kewen-framework-auth\\idaas-application";
        ...
        public static final List<String> CONTAINS_TABLE_PREFIX = Arrays.asList("idaas_*");
