 ...
 *  where application=#{application} and operate=#{operate} and data_id=#{dataId} and authority in ( #{用户权限} )
 *  limit 1
 * dataId需要关联获取 {@link BusinessData}
 * @author kewen
 * @since 2022-11-23
 */
@Documented
...
public @interface AuthCheckDataOperation {
    /**
     * 模块ID
     * @return 模块ID
     */
